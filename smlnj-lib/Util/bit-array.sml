...
(* Poly/ML does not have an equivalent of `Unsafe.Word8Array.create`.
 * This is not used in Reactis because it is a proposed extension
 * of the Basis Library (from 2015).
