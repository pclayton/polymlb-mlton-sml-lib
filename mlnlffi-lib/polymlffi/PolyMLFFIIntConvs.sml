...
structure PolyMLFFIIntConvs =
  struct
    ...
    val cLonglong = Foreign.cLonglong
    val cUlonglong = Foreign.cUlonglong
    ...
    fun makeLargeIntConv conv =
      mapConversion {fromC = LargeInt.fromInt, toC = LargeInt.toInt} conv
    ...
    val cLonglongLarge = Foreign.cLonglongLarge
    val cUlonglongLarge = Foreign.cUlonglongLarge
